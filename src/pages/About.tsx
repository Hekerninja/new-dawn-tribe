    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-50 animate-fade-in transition-colors duration-300">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-all duration-300">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6 text-sm font-medium text-slate-600 dark:text-slate-300">
            <a href="/" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-300 relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-teal-600 after:left-0 after:-bottom-1 after:transition-all after:duration-300 hover:after:w-full">Home</a>
            <a href="/about" className="text-teal-600 dark:text-teal-400 relative after:content-[''] after:absolute after:w-full after:h-0.5 after:bg-teal-600 after:left-0 after:-bottom-1">About</a>
          ...
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <Button onClick={() => window.open("https://wa.me/919529806294", "_blank")} className="bg-teal-600 hover:bg-teal-700 text-white btn-smooth shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
              Book Consultation
            </Button>
          </div>
        </div>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden animate-slide-up">
        ...
        <div className="container mx-auto px-4 text-center max-w-4xl">
          <Link to="/" className="inline-flex items-center text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 mb-8 font-medium animate-slide-up delay-100">
            <ArrowLeft className="w-4 h-4 mr-2" /> Back to Home
          </Link>
          <h1 className="text-4xl md:text-6xl font-bold text-slate-900 dark:text-slate-50 mb-6 leading-tight animate-slide-up delay-200">
            My Journey <br />
            <span className="text-teal-600 dark:text-teal-400">From Darkness to Light</span>
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="animate-slide-up delay-100">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-6">Two Years Ago</h2>
          ...
          <div className="animate-slide-up delay-200">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-6">Why Lived Experience Matters</h2>
            <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
      ...
      {/* Mission Section */}
      <section className="py-20 bg-slate-50 dark:bg-slate-950 animate-slide-up transition-colors duration-300">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-50 mb-4">My Mission</h2>
            <p className="text-slate-600 dark:text-slate-300 text-lg">To help people break free from addiction, rebuild their identity, and create a life they're proud of.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg bg-white dark:bg-slate-900 card-smooth transform hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50 mb-4">Break Free</h3>
                <p className="text-slate-600 dark:text-slate-300">Whether you're at rock bottom or just starting to question your habits, you're not alone — and change is possible.</p>
              </CardContent>
            </Card>
            <Card className="border-none shadow-lg bg-white dark:bg-slate-900 card-smooth transform hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50 mb-4">Rebuild Identity</h3>
                <p className="text-slate-600 dark:text-slate-300">Rediscover who you are beyond addiction. We help you find your true self and build a new, authentic identity.</p>
              </CardContent>
            </Card>
            <Card className="border-none shadow-lg bg-white dark:bg-slate-900 card-smooth transform hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-50 mb-4">Create a Future</h3>
                <p className="text-slate-600 dark:text-slate-300">Build a life you're proud of. We provide the tools and support to create lasting change and a brighter future.</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      {/* Call to Action */}
      <section className="py-20 bg-teal-600 text-white animate-slide-up">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Start Your Journey?</h2>
          <p className="text-teal-100 text-lg mb-8 max-w-2xl mx-auto">
            You don't have to do this alone. Let's work together to reclaim your life and build a future you love.</p>
          <Button onClick={() => window.open("https://wa.me/919529806294", "_blank")} size="lg" className="bg-white text-teal-600 hover:bg-slate-100 text-lg px-8 btn-smooth shadow-lg hover:shadow-xl transform hover:-translate-y-1">
            Book a Consultation
          </Button>
        </div>
      </section>
