...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground animate-fade-in theme-transition">
      {/* Special Offer Banner */}
      <div className="bg-gradient-to-r from-amber-500 to-orange-600 text-white py-3 px-4 text-center relative overflow-hidden animate-slide-up">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-all duration-300">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6 text-sm font-medium text-slate-600 dark:text-slate-300">
            ...
            <Link to="/contact" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-300 relative after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-teal-600 after:left-0 after:-bottom-1 after:transition-all after:duration-300 hover:after:w-full">Contact</Link>
          </div>
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <Link to="/contact">
              <Button className="bg-teal-600 hover:bg-teal-700 text-white btn-smooth shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                Book Consultation
              </Button>
            </Link>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <Card key={index} className={`border-none shadow-lg hover:shadow-xl transition-shadow bg-white dark:bg-slate-900 card-smooth transform hover:-translate-y-2 ${service.popular ? 'ring-2 ring-teal-500 relative' : ''}`}>
                {service.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-teal-600 text-white px-4 py-1 rounded-full text-sm font-medium">Most Popular</div>
                  </div>
                )}
                <CardHeader>
                ...
                <CardContent>
                  <div className="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-slate-700">
                    <div className="text-lg font-bold text-slate-900 dark:text-slate-50">{service.price}</div>
          ...
          <div className="text-center mt-12">
            <Link to="/services">
              <Button size="lg" className="bg-teal-600 hover:bg-teal-700 text-white btn-smooth shadow-md hover:shadow-lg transform hover:-translate-y-1">
                View All Services
              </Button>
            </Link>
          </div>
