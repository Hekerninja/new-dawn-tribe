    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 animate-fade-in">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200 transition-all duration-300">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <span className="text-xl font-bold text-slate-800 transition-colors duration-300 group-hover:text-teal-600">New Dawn Tribe</span>
          </div>
          <div className="hidden md:flex gap-6 text-sm font-medium text-slate-600">
            <a href="#about" className="hover:text-teal-600 transition-colors duration-300 link-underline">About</a>
            <a href="#services" className="hover:text-teal-600 transition-colors duration-300 link-underline">Services</a>
            <a href="#blog" className="hover:text-teal-600 transition-colors duration-300 link-underline">Blog</a>
            <a href="#contact" className="hover:text-teal-600 transition-colors duration-300 link-underline">Contact</a>
          </div>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden animate-slide-up">
        ...
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight animate-slide-up delay-100">
            Reclaim Your Life <br />
            <span className="text-teal-600">One Step at a Time</span>
          </h1>
          <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-2xl mx-auto animate-slide-up delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up delay-300">
            ...
            <Button size="lg" variant="outline" className="border-teal-600 text-teal-600 hover:bg-teal-50 text-lg px-8 btn-smooth shadow-md hover:shadow-lg transform hover:-translate-y-1">
              Read Our Story
            </Button>
          </div>
        </div>
      ...
      {/* About Section */}
      <section id="about" className="py-20 bg-white animate-slide-up">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative group">
              <div className="absolute -inset-4 bg-teal-100 rounded-2xl transform rotate-3 -z-10 transition-transform duration-500 group-hover:rotate-6" />
            ...
            <div className="animate-slide-up delay-100">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Welcome to New Dawn Tribe</h2>
      ...
      {/* Services Section */}
      <section id="services" className="py-20 bg-slate-50 animate-slide-up">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">How We Can Help</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">Comprehensive support tailored to your specific needs and recovery goals.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <Card key={index} className="border-none shadow-lg hover:shadow-xl transition-shadow bg-white card-smooth transform hover:-translate-y-2">
                <CardHeader>
      ...
      {/* Blog Section */}
      <section id="blog" className="py-20 bg-white animate-slide-up">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            ...
            <Button variant="ghost" className="hidden md:flex text-teal-600 hover:text-teal-700 btn-smooth">
              View All Posts <ArrowRight className="ml-2 w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" />
            </Button>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {blogs.map((blog, index) => (
              <Link to={`/blog/${blog.id}`} key={blog.id} className="block group">
                <Card className="border-none shadow-md hover:shadow-lg transition-all cursor-pointer overflow-hidden h-full card-smooth transform hover:-translate-y-2">
                  ...
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-teal-600 transition-colors duration-300">{blog.title}</h3>
          ...
          <div className="mt-8 text-center md:hidden">
            <Button variant="outline" className="w-full text-teal-600 border-teal-600 btn-smooth">View All Posts</Button>
          </div>
        </div>
      </section>

      {/* Social Media & Contact Section */}
      <section id="contact" className="py-20 bg-slate-900 text-white animate-slide-up">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <Card className="bg-white text-slate-900 border-none shadow-xl card-smooth transform hover:-translate-y-2">
              <CardHeader>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <Input placeholder="Your Name" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="transition-all duration-300 focus:ring-2 focus:ring-teal-500" />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-1 block">Email</label>
                    <Input type="email" placeholder="your@email.com" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="transition-all duration-300 focus:ring-2 focus:ring-teal-500" />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-1 block">Message</label>
                    <Textarea placeholder="How can we help you?" rows={4} value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="transition-all duration-300 focus:ring-2 focus:ring-teal-500" />
                  </div>
      ...
      {/* Footer */}
      <footer className="bg-slate-950 text-slate-400 py-8 border-t border-slate-800 animate-fade-in">
        <div className="container mx-auto px-4 text-center">
