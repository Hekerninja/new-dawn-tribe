...
const Index = () => {
  ...
  return (
    <div className="min-h-screen font-sans text-foreground animate-fade-in theme-transition relative">
      ...
      <div className="bg-gradient-to-r from-amber-500 to-orange-600 text-white py-3 px-4 text-center relative overflow-hidden animate-slide-up z-10">
        ...
        <div className="container mx-auto flex items-center justify-center gap-2 relative z-10">
          ...
          <Link to="/contact" className="ml-4 bg-white text-amber-600 hover:bg-amber-50 px-4 py-1.5 rounded-full font-semibold text-sm transition-all duration-300 transform hover:scale-105 shadow-md flex items-center gap-1">
            Sign Up Now
      ...
      <section className="relative py-20 md:py-32 overflow-hidden animate-slide-up z-10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto animate-slide-up delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up delay-300">
            <Button onClick={handleWhatsAppClick} size="lg" className="bg-teal-500 hover:bg-teal-600 text-white text-lg px-8 btn-smooth shadow-lg hover:shadow-xl transform hover:-translate-y-1">
              Start Your Journey
            </Button>
            <Link to="/about">
              <Button size="lg" variant="outline" className="border-teal-400 text-teal-400 hover:bg-teal-500/10 text-lg px-8 btn-smooth shadow-md hover:shadow-lg transform hover:-translate-y-1">
                Read Our Story
              </Button>
            </Link>
          </div>
      ...
      {/* About Section */}
      <section id="about" className="py-20 bg-black/20 backdrop-blur-sm animate-slide-up transition-colors duration-300 z-10">
      ...
      {/* Services Section */}
      <section id="services" className="py-20 bg-black/30 backdrop-blur-sm animate-slide-up transition-colors duration-300 z-10">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <Card key={index} className={`border border-white/10 shadow-lg hover:shadow-xl transition-shadow bg-black/40 backdrop-blur-sm card-smooth transform hover:-translate-y-2 ${service.popular ? 'ring-2 ring-teal-400 relative' : ''}`}>
                {service.popular && (
          ...
          <div className="text-center mt-12">
            <Link to="/services">
              <Button size="lg" className="bg-teal-500 hover:bg-teal-600 text-white btn-smooth shadow-md hover:shadow-lg transform hover:-translate-y-1">
                View All Services
              </Button>
            </Link>
          </div>
      ...
      {/* Blog Section */}
      <section id="blog" className="py-20 bg-black/20 backdrop-blur-sm animate-slide-up transition-colors duration-300 z-10">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            ...
            <Button variant="ghost" className="hidden md:flex text-teal-400 hover:text-teal-300 btn-smooth">
              View All Posts
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {blogs.map((blog, index) => (
              <Link to={`/blog/${blog.id}`} key={blog.id} className="block group">
                <Card className="border border-white/10 shadow-md hover:shadow-lg transition-all cursor-pointer overflow-hidden h-full card-smooth transform hover:-translate-y-2 bg-black/40 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2 group-hover:text-teal-400 transition-colors duration-300">{blog.title}</h3>
                    <p className="text-gray-300 mb-4 line-clamp-2">{blog.excerpt}</p>
                    <span className="text-teal-400 font-medium text-sm flex items-center group-hover:translate-x-1 transition-transform duration-300">
                      Read More
          ...
          <div className="mt-8 text-center md:hidden">
            <Button variant="outline" className="w-full text-teal-400 border-teal-400 btn-smooth">View All Posts</Button>
          </div>
        </div>
      </section>

      {/* Contact Section */}
      <section id="contact" className="py-20 bg-black/40 backdrop-blur-sm text-white animate-slide-up transition-colors duration-300 z-10">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-4 group">
                  <div className="bg-teal-500 p-3 rounded-full transition-transform duration-300 group-hover:scale-110">
            ...
            <Card className="bg-black/50 backdrop-blur-sm text-white border border-white/10 shadow-xl card-smooth transform hover:-translate-y-2">
              <CardHeader>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <Input placeholder="Your Name" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="transition-all duration-300 focus:ring-2 focus:ring-teal-400 bg-black/50 border-white/10 text-white placeholder:text-gray-500" />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-1 block text-gray-300">Email</label>
                    <Input type="email" placeholder="your@email.com" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="transition-all duration-300 focus:ring-2 focus:ring-teal-400 bg-black/50 border-white/10 text-white placeholder:text-gray-500" />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-1 block text-gray-300">Message</label>
                    <Textarea placeholder="How can we help you?" rows={4} value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="transition-all duration-300 focus:ring-2 focus:ring-teal-400 bg-black/50 border-white/10 text-white placeholder:text-gray-500" />
                  </div>
                  <Button type="submit" className="w-full bg-teal-500 hover:bg-teal-600 text-white btn-smooth shadow-md hover:shadow-lg" disabled={isSubmitting}>
