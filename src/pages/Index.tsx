...
const Index = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (EMAILJS_PUBLIC_KEY === "YOUR_PUBLIC_KEY") {
      showError("EmailJS configuration is missing. Please add your keys in the code.");
      return;
    }
    ...
    try {
      const templateParams = {
        ...
        to_email: "newdawntribe@gmail.com" // This will be the recipient
      };
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={handleWhatsAppClick} size="lg" className="bg-teal-600 hover:bg-teal-700 text-white text-lg px-8">Start Your Journey</Button>
