...
import { Phone, Mail, Instagram, Facebook, Twitter, Linkedin, ArrowRight, Calendar, Heart, Shield, Users, MessageSquare } from 'lucide-react';
...
const blogs = [
  ...
  { id: 2, title: "Building a Support System That Lasts", excerpt: "Why having the right people around you is crucial for long-term sobriety and mental well-being.", date: "Oct 22, 2023", readTime: "7 min read" },
  { id: 3, title: "Mindfulness Techniques for Cravings", excerpt: "Practical mindfulness exercises to help you manage urges and stay grounded in the present moment.", date: "Oct 29, 2023", readTime: "6 min read" }
];
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Button className="bg-teal-600 hover:bg-teal-700 text-white">Book Consultation</Button>
        </div>
      </nav>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-teal-600 hover:bg-teal-700 text-white text-lg px-8">Start Your Journey</Button>
            <Button size="lg" variant="outline" className="border-teal-600 text-teal-600 hover:bg-teal-50 text-lg px-8">Read Our Story</Button>
          </div>
        </div>
      </section>
      ...
      <section id="blog" className="py-20 bg-white">
        <div className="container mx-auto px-4">
            ...
            {blogs.map((blog) => (
              <Card key={blog.id} className="border-none shadow-md hover:shadow-lg transition-all cursor-pointer group">
                ...
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-teal-600 transition-colors">{blog.title}</h3>
          ...
          <div className="mt-8 text-center md:hidden">
            <Button variant="outline" className="w-full text-teal-600 border-teal-600">View All Posts</Button>
          </div>
        </div>
      </section>
            ...
            <Card className="bg-white text-slate-900 border-none shadow-xl">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-teal-600 hover:bg-teal-700 text-white">Send Message</Button>
                </form>
              </CardContent>
            </Card>
          </div>
      ...
      <footer className="bg-slate-950 text-slate-400 py-8 border-t border-slate-800">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; 2025 New Dawn Tribe. All rights reserved.</p>
